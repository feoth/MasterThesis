...
\begin{figure}[h]
	...
	\caption{Солитоны в стержне радиуса $R = 10^{-2} m$, сделанном из полистирола при $A = -0.07$ (слева) и $A= -0.001$ (справа). Упругие модули полистирола в таблице~\ref{tab:ps}.}
	\label{fig:soliton}
\end{figure}
