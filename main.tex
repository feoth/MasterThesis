...
\end{flalign}
На рис. ... представлена эволюция этого импульса и зарождение солитона при $A_0=0.05$, $W=20$, где по горизонтальной оси отложена бегущая координата $\xi = x - ct$.

Сравним оторвавшийся импульс с солитонным решением уравнения \eqref{eq_dim_free_surf}:

Теперь решим аналогичную задачу Коши для регуляризованного уравнения типа Буссинеска, где начальное условие задано формулой \eqref{3_ic_u} (выражение поперечного перемещения $V$ через продольное $U$ уже <<зашито>> в модель).

На рис. ... представлено сравнение эволюции импульса согласно полным уравнениям и согласно модели типа Буссинеска.

На основе численных решений задачи Коши для полных уравнений с начальными импульсами разной амплитуды построим <<экспериментальную>> зависимость скорости/длины от амплитуды образовавшегося солитона и сравним её с теоретической, задаваемой формулой ...
