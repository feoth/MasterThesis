...
%\label{Bimod}
%\tilde{B}_i &= \sqrt{\frac{c^2(v^2- c^2)}{-4\left(\alpha_1^{(i)} v^4 + \alpha_2^{(i)} c^2 v^2 + \alpha_3^{(i)}c^4\right)R^2}} \, , \quad i = \overline{1,4}.
%\end{align}
...
\begin{thebibliography}{99}
	...
	\bibitem{SP} Samsonov~A.\,M., Porubov~A.\,V., Refinement of the model for the propagation of longitudinal strain waves in a rod with nonlinear elasticity, Tech. Phys. Lett., 1993, 19~(6), 365-366.
